%% ===========================  Figure 4E ============================================
%Values of the free-energy barriers as a function of temperature. 
...
var_all = cat(2,squeeze(Delta_0_12(:,:,1)),squeeze(Delta_0_21(:,:,1)));
Y_var = nanmean(var_all,2);
Y_std = nanstd(var_all');
...
box off
xlabel('T (°C)')
title('barrier 0 to 1')
xlim([1,5])

%
var_all = cat(2,squeeze(Delta_0_12(:,:,2)),squeeze(Delta_0_21(:,:,2)));
Y_var = nanmean(var_all,2);
Y_std = nanstd(var_all');
